...
.component('restaurantShow', {
  template: `
    ...
    <p><b>Completed: </b>
      <span ng-show="$ctrl.restaurant.completed" class="glyphicon glyphicon-ok" aria-hidden="true"></span>
      <span ng-hide="$ctrl.restaurant.completed" class="glyphicon glyphicon-unchecked" aria-hidden="true"></span>
    </p>
    <p><b>Created: </b>{{ $ctrl.restaurant.updatedAt | date : "medium" }}</p>
    <p><b>Last Updated: </b>{{ $ctrl.restaurant.createdAt | date : "medium" }}</p>
